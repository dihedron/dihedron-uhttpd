...
import org.dihedron.core.variables.MapBasedValueProvider;
...
import org.dihedron.ehttpd.server.handlers.WebHandler;
 ...
 * @author Andrea Funto'
 */
public class WebPageRequestHandler extends WebHandler {
	...
	protected void service(Request request, Response response) throws ServerException {
		// TODO: check on this!
		String result = Variables.replaceVariables(template, new MapBasedValueProvider(variables), messageProvider);
